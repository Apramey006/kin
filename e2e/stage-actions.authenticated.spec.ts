...
// Restore by removing this skip once an authenticated Playwright fixture exists (middleware now redirects /stage to /signin).
base.skip(true, "needs an authenticated session fixture");
