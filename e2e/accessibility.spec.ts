  ...
  data.events = [
    {
      ...
      evidence: [{ memoryId:"memory", contributorId:relativeId, subjectNodeId:"nora", source:"human", supportedFacts:["Nora always wore a yellow apron."] }],
      keeper_results: [
        {
          keeperId: relativeId,
          support: "supports",
          ...
          evidence: [
            {
              memoryId: "memory", contributorId:relativeId, subjectNodeId:"nora", source:"human",
              supportedFacts: ["Nora and Rosa baked lemon cake every Sunday."],
            },
          ],
        },
      ],
