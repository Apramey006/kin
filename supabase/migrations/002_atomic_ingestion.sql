...
alter table public.memories add column source jsonb;
alter table public.memories add column verified_facts jsonb not null default '[]'::jsonb;
alter table public.face_embeddings add column model text;
