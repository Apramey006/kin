...
- `npm test`: 41 unit tests pass. The two database integrations are skipped here.
...
- `npm run test:e2e`: 20 Chromium tests pass. Coverage includes real sign-in,
...
- Real iPhone/Safari camera, microphone, sheet gestures, and earbud output.
